...
public class Menu {
    ...
    /**
     * Menu principal, donne trois choix à l'user
     * @throws DatabaseException exception de properties qui gère si le fichier .env est lisible/correct ou non
     * @throws PropertiesException exception qui gère les échecs de connexion à la bdd
     */
    public void menu() throws DatabaseException, PropertiesException {
    ...
    /**
     * Menu de choix création de personnage, à partir de la BDD ou en créer un nouveau
     * @throws DatabaseException exception de properties qui gère si le fichier .env est lisible/correct ou non
     * @throws PropertiesException exception qui gère les échecs de connexion à la bdd
     */
    public void character_creation () throws DatabaseException, PropertiesException {
        Scanner keyboard = new Scanner(System.in);
    ...
    /**
     * Affiche la liste des personnages présents dans la bdd sous forme de liste d'objets
     ...
     */
    public void bdd_characters_list () throws PropertiesException, DatabaseException {
        List<Characters> charactersList = BDD_connexion.select_heroes();
    ...
    /**
     * Menu de création d'un nouveau personnage par l'user
     * @throws PropertiesException exception de properties qui gère si le fichier .env est lisible/correct ou non
     * @throws DatabaseException exception qui gère les échecs de connexion à la bdd
     */
    public void new_character_creation() throws PropertiesException, DatabaseException {
        Scanner keyboard = new Scanner(System.in);
        String key;
    ...
    /**
     * Menu de création d'un personnage qui traite la création d'un objet Warrior par l'user
     * @return Le nouvel objet new_warrior
     */
    ...
    /**
     * Menu de création d'un personnage qui traite la création d'un objet Wizard par l'user
     * @return le nouvel objet new_wizard
     */
    ...
    /**
     * Affiche le nouveau Warrior et ses caractéristiques crées par l'user
     */
    ...
    /**
     * Affiche le nouveau Wizard et ses caractéristiques crées par l'user
     */
    ...
    /**
     * Menu de choix pour la mise à jour des personnages crées par l'user
     * @param name Le nom du nouveau personnage
     * @param health La santé du nouveau personnage
     * @param force La force du nouveau personnage
     * @param class_name La classe du nouveau personnage
     */
    ...
    /**
     * Met à jour le Warrior et affiche les nouvelles caractéristiques
     * @param name Nom du Warrior
     * @param health Santé du Warrior [5, 10]
     * @param force Force du Warrior [5, 10]
     */
    ...
    /**
     * Met à jour le Wizard et affiche les nouvelles caractéristiques
     * @param name Le nom di Wizard
     * @param health La santé du Wizard [3, 6]
     * @param force La force du Wizard [8, 15]
     */
